...
params.base_dir = "${params.base_dir ?: launchDir}"
params.out_dir = "${params.base_dir}/data"
params.data_dir = "${params.base_dir}/data"
params.db = "${params.base_dir}/data/medi_db"
